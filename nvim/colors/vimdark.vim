...
hi CursorLine   ctermbg=242  ctermfg=254 cterm=None         guibg=#4b4b4b  guifg=None gui=None
...
hi ColorColumn   ctermbg=None ctermfg=None cterm=None        guibg=#3b3b3b guifg=None gui=None
